...
public class CategorizeStrings2 {
    public static void main (String[] args) {
        ...
        System.out.println("\nDo you want to see the list of one word strings or the list of two word strings or longer string?");
        System.out.print(" Please enter O or T or L or " + QUIT + " to quit >> ");
        ...
        while(!entry.equals(QUIT)) {
            ...
            System.out.print(" Please enter S or L or " + QUIT + " to quit >> ");
